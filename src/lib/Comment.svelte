<script lang="ts">
  ...
  function addChildComment(childComment: PostComment): Promise<boolean> {
    return new Promise<boolean> ((resolve, reject) => {
      var newData = data;
      newData.children.push(childComment);
      data = newData;
      replyMode = false;
      resolve(true);
    });
  ...
  <div>
    ...
    <div class="content">
      ...
      <div class="comment_footer">
        <span class="like_box" on:click={upvote}>
        ...
        <span class="reply_box">
          {#if !replyMode}
            <span class="reply_link" on:click={startReply}>
              <span class="reply_text">Reply</span>
            </span>
          {:else}
            <span class="reply_link" on:click={cancelReply}>
    ...
    {#if replyMode}
      <div class="reply_frame">
        <NewComment parentId={data.id} submit={addChildComment} />
      </div>
    {/if}
  </div>
